...
type CreateOrderJSONRequestBody = OrderInfo
...
type CreateOrder400JSONResponse struct {
	...
	// Description Развернутое пояснение ошибки
	Description *string `json:"description,omitempty"`
	Details     *[]struct {
		// Path JSON-путь до проблемного поля в запросе.
